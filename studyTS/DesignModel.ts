...
abstract class Worker996{
    private _anme:string;
    constructor(name:string){
        this._anme = name;
    }

    public showOnyDay():void{
    ...
    private enterCompany():void{
        console.log( this._anme + '进入公司');
    }

    protected exitCompany():void{
        console.log(this._anme + '离开公司');
    }

    protected get isNeedPrintData():boolean{
        return false;
    }
}

class ITWorker extends Worker996{
    work(): void {
...
class HRWorker extends Worker996 {
    work(): void {
