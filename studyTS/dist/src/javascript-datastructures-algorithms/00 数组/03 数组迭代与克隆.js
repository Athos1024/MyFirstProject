...
// 04 map
var myMap = numbers.map(function (el) { return el * 2; });
// 05 filter
var myFilter = numbers.filter(isEven);
// 06 reduce
var myReduce = numbers.reduce(function (sum, el) { return (sum = sum + el); }, 0);
...
/*  数组克隆方式  */
// 01 Array.from方法
var numbers2 = Array.from(numbers, function (el) { return el * 3; });
// 02 Array.of方法
var tests = Array.of('4', '5', '6');
var numbers3 = Array.of.apply(Array, numbers2);
/* 数组的其他方法 */
// 01 fill (target,start,end)
numbers3.fill(5, 2, 4);
// 02 copyWithin  (target,start,end)
numbers3.copyWithin(0, 2, 4);
//# sourceMappingURL=03%20%E6%95%B0%E7%BB%84%E8%BF%AD%E4%BB%A3%E4%B8%8E%E5%85%8B%E9%9A%86.js.map